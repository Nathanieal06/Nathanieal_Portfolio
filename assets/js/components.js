        ...
        <ul class="nav-menu">
            ...
            <li class="has-dropdown">
                ...
                <ul class="nav-dropdown-menu">
                    ...
                    <li><a href="${root}pages/certificates.html#cert9">Semi Finals</a></li>
            ...
            <li><a href="${root}assets/Resume/Nathanieal_Sandipurti_Resume_Updated.pdf" target="_blank"><svg class="nav-icon" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> <span class="nav-text">Resume</span></a></li>
        </ul>
    </div>
</nav>`;
